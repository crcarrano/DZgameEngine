...
class DZsoundSystem
{
	public:
		...
		bool	isMusicPlaying();
		bool	isMusicPaused();
		bool	isMusicAvailable(unsigned int id);
		...
		bool	isEffectAvailable(unsigned int id);
	...
	private:
		...
		DZarray<SOUND_EFFECT*>*	soundEffectListPtr;	// list of sound effects
		DZarray<MUSIC_PIECE*>*	musicListPtr;		// list of music pieces
